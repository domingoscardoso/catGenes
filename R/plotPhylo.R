...
#' 
#' @param side_phylogram, if \code{TRUE}, a small phylogram with branch lengths
#' will be plotted on the upper left.
#' 
#' @param phylogram_supports, if \code{TRUE}, the side phylogram will include
#' the the same symbols of node support as those plotted in the main edited tree.
#' 
...
#' 
#' Harpalyce_clade <- "Harpalyce"
#' outgroup_taxa <- c("Staminodianthus", "Guianodendron", "Diplotropis",
#'                    "Leptolobium", "Bowdichia", "Clathrotropis", "Dermatophyllum")
#' 
...
#'}
#'
#' @importFrom ggtree ggtree MRCA geom_tiplab geom_hilight xlim_tree geom_text2 geom_point2 geom_treescale
#' @importFrom treeio isTip 
#' @importFrom ggplot2 annotate annotation_custom aes scale_colour_manual ggplotGrob
